...
const Merger = () => {
  ...
  return (
    <div className="p-4">
      <h1 className={`text-2xl text-center ${myFont.className} mb-10`}>générateur de slogan</h1>
      ...
      <div className="text-center">
        <p className="mb-2">Ajoutez un ou des symboles (cliquer pour ajouter)</p>
        <ul className="inline-grid grid-cols-3 gap-2 mb-8">
          {Object.keys(helpedChars).map((c) => {
            return (
              <li className={`${myFont.className} bg-[#a132b8] hover:bg-[#cc74e0]  text-white font-bold py-2 px-4 rounded inline-flex items-center`}
                onClick={() => {
      ...
      {charCount > 0 && <p className="text-center">Apperçu de votre slogan ({charCount} pages)</p> }
      <h1 className={`tracking-wide text-3xl ${myFont.className} text-center mb-8 leading-relaxed`}>{inputValue}</h1>

      <div className="text-center">
        {files.length > 0 && (
          <div className="inline-grid grid-cols-2 gap-2">
            <button className="bg-[#a132b8] hover:bg-[#cc74e0] text-white font-bold py-2 px-4 rounded inline-flex items-center" onClick={handlePrint}>
            ...
            <a className="bg-[#a132b8] hover:bg-[#cc74e0] text-white font-bold py-2 px-4 rounded inline-flex items-center" href={`${mergedPdfUrl}`} download>
